...
// Terrible hack for terrible library
...
export const Work: React.SFC = () => {
  const armyCarouselRef = useRef<HTMLDivElement | null>(null);
  const armyCarouselSmallRef = useRef<HTMLDivElement | null>(null);

  useEffect(() => {
    if (!armyCarouselRef.current) return;
    applyFlickity(armyCarouselRef.current);
  }, [armyCarouselRef.current]);

  useEffect(() => {
    if (!armyCarouselSmallRef.current) return;
    applyFlickity(armyCarouselSmallRef.current);
  }, [armyCarouselSmallRef.current]);
    ...
    <section className="work section">
      <div className="container">
        ...
        <div className="columns is-multiline is-hidden-touch is-hidden-desktop-only">
          <div className="column is-full-mobile is-full-tablet is-full-desktop is-one-quarter-widescreen is-one-quarter-fullhd">
            ...
            <p>
              ...
              roots, Convoke developed a gritty brand identity that was brought
              to life with a Twitch broadcast package, onsite assets and digital
              marketing support. Operated by Atomic Infotech, the Warrior Zone
              Majors will continue throughout 2019 with Smash Bros, Call of
              Duty, Madden and NBA2K.
            </p>
          </div>
          <div className="column is-full-mobile is-full-tablet is-full-desktop is-three-quarters-widescreen is-three-quarters-fullhd">
            <div ref={armyCarouselRef} className="carousel-media">
        ...
        <div className="columns is-multiline is-hidden-widescreen">
          <div className="column is-full-mobile is-full-tablet is-full-desktop is-three-quarters-widescreen is-three-quarters-fullhd">
            <div ref={armyCarouselSmallRef} className="carousel-media">
              <div className="carousel-media-cell">
                <video autoPlay loop muted playsInline>
                  <source
                    src="https://i.imgur.com/k4mLihm.mp4"
        ...
        <div className="columns is-multiline">
          ...
          <div className="column is-full-mobile is-full-tablet is-full-desktop is-one-quarter-widescreen is-one-quarter-fullhd">
            ...
            <p>
              ...
              completing a rebrand that positioned them as one of the East
              Coast’s premier tech and innovation conferences. Our task was to
              help Thrival reach a completely new audience and guide them from
